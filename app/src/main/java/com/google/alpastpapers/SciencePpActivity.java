...
public class SciencePpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.science_pp);
        ...
        PP2019.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SciencePpActivity.this,view2019pp.class);
        ...
        PP2018.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SciencePpActivity.this,view2018pp.class);
                startActivity(intent);
            }
        });
        ...
        PP2017.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SciencePpActivity.this,View2017ppActivity.class);
                startActivity(intent);
        ...
        PP2016.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SciencePpActivity.this,view2016pp.class);
                startActivity(intent);
        ...
        PP2015.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SciencePpActivity.this,view2015pp.class);
                startActivity(intent);
        ...
        PP2014.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SciencePpActivity.this,view2014pp.class);
                startActivity(intent);
